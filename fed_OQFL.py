...
from CustomTensorDataset import LoadFromFolder
matplotlib.use('Agg')
...
sys.path.append('/home/white_wolf/Desktop/ACN Project/models')

from models.vggLSQ2 import *
...
if __name__ == '__main__':
    ...
    if args.dataset == 'mnist':
        ...
        dataset=LoadFromFolder(main_dir="./images/train", transform=transforms)
        dataset_train=DataLoader(dataset)
        dataset1=LoadFromFolder(main_dir="./images/test", transform=transforms)
        dataset_test = DataLoader(dataset1)
        # sample users
        if args.iid:
